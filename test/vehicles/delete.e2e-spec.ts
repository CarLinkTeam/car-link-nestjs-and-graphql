...
describe('VehiclesModule Delete (e2e)', () => {
  ...
  it('/vehicles/:id (DELETE) - without authentication', async () => {
  ...
  it('/vehicles/:id (DELETE) - user without owner role', async () => {
  ...
  it('/vehicles/:id (DELETE) - different owner', async () => {
    const response = await request(app.getHttpServer())
      .delete(`/vehicles/${vehicleId}`)
      .set('Authorization', `Bearer ${otherOwnerToken}`);
  ...
  it('/vehicles/:id (DELETE) - ID not exists', async () => {
  ...
  it('/vehicles/:id (DELETE) - remove succesfully', async () => {
    const response = await request(app.getHttpServer())
      .delete(`/vehicles/${vehicleId}`)
      .set('Authorization', `Bearer ${ownerToken}`);
